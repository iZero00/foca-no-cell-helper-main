...
const normalizeChartId = (rawId: string) => rawId.replace(/[^a-zA-Z0-9_-]/g, "_");
...
>(({ id, className, children, config, ...props }, ref) => {
  ...
  const chartId = normalizeChartId(`chart-${id || uniqueId.replace(/:/g, "")}`);
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  const chartId = normalizeChartId(id);
